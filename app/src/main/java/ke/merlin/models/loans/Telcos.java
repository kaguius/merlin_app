 ...
 */
public class Telcos implements Serializable {
    private String id;
    private String name;
    private String description;
    private String countryId;
    private String telcoImagePath;
    ...
    public String getTelcoImagePath() {
        return telcoImagePath;
    }

    public void setTelcoImagePath(String telcoImagePath) {
        this.telcoImagePath = telcoImagePath;
    }
