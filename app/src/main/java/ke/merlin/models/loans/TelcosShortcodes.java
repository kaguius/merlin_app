...
public class TelcosShortcodes {
    private String id;
    private String name;
    private String description;
    private String shortcodeTypeId;
    ...
    public String getShortcodeTypeId() {
        return shortcodeTypeId;
    }

    public void setShortcodeTypeId(String shortcodeTypeId) {
        this.shortcodeTypeId = shortcodeTypeId;
    }
