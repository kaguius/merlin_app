 ...
 */
public class LoansApplications implements Serializable {
    private String id;
    ...
    public String getTelcosId() {
        return telcosId;
    }

    public void setTelcosId(String telcosId) {
        this.telcosId = telcosId;
    }
