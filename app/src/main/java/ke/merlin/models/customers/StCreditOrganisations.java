...
public class StCreditOrganisations {
    private String id;
    private String name;
    private String description;
    private String creditOrganisationTypeId;
    ...
    public String getCreditOrganisationTypeId() {
        return creditOrganisationTypeId;
    }

    public void setCreditOrganisationTypeId(String creditOrganisationTypeId) {
        this.creditOrganisationTypeId = creditOrganisationTypeId;
    }
